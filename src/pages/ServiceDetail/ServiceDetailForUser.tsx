// pages/ServiceDetail/ServiceDetailForUser.tsx
...
const ServiceDetailForUser: React.FC = () => {
  ...
  // ✅ Debug Redux state
  useEffect(() => {
    console.log("Redux state:", { currentService, loading, error });
  }, [currentService, loading, error]);
  ...
  // Loading state - ❌ Bỏ AppLayoutForUser wrapper
  if (loading) {
    return (
  ...
  // Error state - ❌ Bỏ AppLayoutForUser wrapper
  ...
  // Success state - ❌ Bỏ AppLayoutForUser wrapper
  return (
