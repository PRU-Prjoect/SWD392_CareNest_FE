    ...
    <header className="sticky top-0 flex w-full bg-[#2A9D8F] shadow-md z-50 border-b border-blue-600 dark:bg-gray-900 dark:border-gray-800">
      <div className="flex flex-col items-center justify-between grow lg:flex-row lg:px-6">
        <div className="flex items-center justify-between w-full gap-2 px-3 py-3 border-b border-gray-200 dark:border-gray-800 sm:gap-4 lg:justify-normal lg:border-b-0 lg:px-0 lg:py-4">
          <button
            className="items-center justify-center w-10 h-10 text-white border-gray-200 border-2 rounded-lg z-99999 dark:border-gray-800 lg:flex dark:text-gray-400 lg:h-11 lg:w-11 lg:border"
          ...
          <button
            ...
            className="flex items-center justify-center w-10 h-10 text-white rounded-lg z-99999 hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-800 lg:hidden"
          >
            <svg
              width="24"
              height="24"
          ...
          <div className="flex items-center gap-4 2xsm:gap-6">
            ...
            <div className="relative">
              <button
                ...
                className="relative w-10 h-10 overflow-hidden rounded-full ring-2 ring-white dark:ring-gray-300 focus:outline-none"
              >
                <img
